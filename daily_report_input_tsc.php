...
<style>
    ...
    <script>
        ...
        function time_att_cal(){
            ...
            var att_admin = parseInt($("#att_admin").val());
            ...
            var att_total = (att_asst_mgr+att_supervisor+att_leader+att_operator+att_admin)-att_late;
        ...
        function save_daily_report_tsc(){
            ...
            var ot_admin_prs = $("#ot_admin_prs").val();
            var ot_admin_hrs = $("#ot_admin_hrs").val();
            ...
            var issue_remark_vmi = $("#issue_remark_vmi").val();
			
			 var order_packing= $("#order_packing").val();
			 var order_complete_packing= $("#order_complete_packing").val();
			 var order_delivery_packing= $("#order_delivery_packing").val();
			 var order_performance_packing= $("#order_performance_packing").val();
			
			 var order_packing_export= $("#order_packing_export").val();
			 var order_complete_packing_export= $("#order_complete_packing_export").val();
			 var order_delivery_packing_export= $("#order_delivery_packing_export").val();
			 var order_performance_packing_export= $("#order_performance_packing_export").val();
        ...
        function approve_daily_report_tsc(){
            var report_date = $("#report_date").val();
            var shift = $("#shift").val();
            var safety_human = $("#safety_human").val();
            var safety_part = $("#safety_part").val();
            ...
            if(ot_target==""){
                ...
                $.post( "getajax_daily_report_tsc.php", { 
                    status: "approve_daily_report_tsc",
                    report_date : report_date,
                    shift : shift,
                    safety_human : safety_human,
                    safety_part : safety_part,
        ...
        function show_receive_box(shift){
            $("#show_detail_head").html("Receive & Put Away Performace (Box Plastic)");
            $("#show_detail_body").html("Loading....");
            $("#myModal_show_detail").modal();
            var report_date = $("#report_date").val();
        ...
        function show_issue_order(shift){
            $("#show_detail_head").html("Issue performance (Box Plastic)");
            $("#show_detail_body").html("Loading....");
            $("#myModal_show_detail").modal();
            var report_date = $("#report_date").val();
        ...
        function show_key_activity_inventory(){
            ...
            var report_date = $("#report_date").val();
            $.post( "getajax_daily_report_key_activity.php", { 
                status: "show_key_activity_inventory_tsc",
                report_date : report_date
            })
            .done(function( data ) { 
                //alert(data);
        ...
        function save_inventory(){
            ...
            var status_inventory = $("#status_inventory").val();
            // alert(plan_count_date);

            $.post( "getajax_daily_report_key_activity.php", { 
                status: "save_inventory_tsc",
                report_date : report_date,
        ...
        function update_inventory_tsc(id){
            var status_inventory_edit = $("#status_inventory_edit"+id).val();
            $("#myModal_loading").modal({backdrop: "static"});
            $.post( "getajax_daily_report_key_activity.php", { 
                status: "update_inventory_tsc",
                id : id,
        ...
        function delete_inventory_tsc(id){
            if(confirm("ต้องการลบข้อมูลหรือไม่")){
                // alert("y");
                $("#myModal_loading").modal({backdrop: "static"});
                $.post( "getajax_daily_report_key_activity.php", { 
                    status: "delete_inventory_tsc",
                    id : id
                })
                .done(function( data ) {
                    // alert(data);
                                            ...
                                            <div class="col-sm-12">
                                                <div class="form-inline">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <select name="shift" id="shift" class='form-control' onchange="select_date_report_tsc();">
