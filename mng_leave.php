	...
	$.ajax({
			...
			success: function(data) {
				...
				for(var i=0;i<data.length;i++){
					emp_all += "<option value="+data[i]['emp_no']+">"+data[i]['emp_name']+"</option>";
				}
				$("#emp_all").html(emp_all);
			}
	});
	$.ajax({
			url: 'emp_control.php',
	...
	$('#emp_all').multiSelect({
		...
		afterSelect: function(values){
			$.ajax({
				...
				async: false,
				dataType: "json",
				data   : {type:'add_under',emp_no:values}
			});
		},
		afterDeselect: function(values){
			$.ajax({
				...
				async: false,
				dataType: "json",
				data   : {type:'del_under',emp_no:values}
			});
		}
    });
				...
				<div class="col-md-12">
					<div class="panel panel-primary">
						...
						<div class="panel-body">
							 ...
							 <select id='emp_all' class="searchable" multiple='multiple' ></select>
					  </div>
					</div>
				</div>
			</div>
