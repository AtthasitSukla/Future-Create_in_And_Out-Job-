...
function date_format_uk_from_databese($date){
...
function get_departmentname($departmentid){
...
function get_site_name($empno){
	$sql = "select site from tbemployee where empno='$empno'";
	$res = mssql_query($sql);
	$row = mssql_fetch_array($res);
	$csite = $row['site'];
...
function send_mail($email,$subject,$body){//
	//require("PHPMailer/class.phpmailer.php");  // เรียกไฟล์ class.phpmailer.php
