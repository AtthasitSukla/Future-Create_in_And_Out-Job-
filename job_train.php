...
formData.append("tra_time",$("#tra_time").val());
	...
	<div class="modal-dialog">
	  ...
	  <div class="modal-content" style="width:100%">
		<form action="" method="post" enctype="multipart/form-data" name="myform1" id="myform1" style="margin-left:10px">
            ...
            <TR>
					<TD id="tr_h">Select Group : </TD><TD><select id="tra_group" name="tra_group">
                    <option value="">Select</option>
                    <option value="QP">QP</option>
                    <option value="JD">JD</option>
                     <option value="WI">WI</option>
                     <option value="Q-Point">Q-Point</option>
				...
				<TR>
					<TD id="tr_h">หัวข้อที่สอน : </TD><TD> <input type="hidden" name="title_id" id="title_id" value=0><input type="text" name="title_name" id="title_name" size="60"></TD>
				</TR>
				<TR>
					<TD id="tr_h">ลักษณะงาน : </TD><TD> <input type="text" name="title_desc" id="title_desc" size="60"></TD>
				</TR>
				<TR id="show_pos">
					<TD id="tr_h"></TD><TD> <input type="hidden" id="sl_dep" name="sl_dep">
					</TD>
				</TR>
				<TR>
					<TD id="tr_h">ใช้เวลา  : </TD><TD>  <input type="text" id="tra_time" name="tra_time"> ชม.
									</TD>
				</TR>
				<TR>
					<TD></TD><TD><br><input type="submit" class="btn btn-success" id="btn_save" value="บันทึก"> <button type="button" id="btn_cancel" class="btn btn-warning">ยกเลิก</button><br></TD>
				</TR>
			</TABLE>
