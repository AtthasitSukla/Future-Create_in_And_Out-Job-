...
// $job_type_array = array(
//     "HQ" => array("SAB","NHK","Oreo","MD","Foggy"),
//     "TSC" => array("Box Manage","VMI","Packing"),
//     "OSW" => array("Box Manage"),
// );

// print_r($job_type_array);
...
<head>
    ...
    <script>
        ...
        function save_request_ot(){
            ...
            var salary_rate = $("select[name='salary_rate[]']").map(function(){return $(this).val();}).get();
            // alert(salary_rate);
            ...
            var job_type = $("select[name='job_type[]']").map(function(){return $(this).val();}).get();
                ...
                <div class="container">
                    ...
                    <?php if ($status == "") {  
                        ...
                        if($status_level >= 3  && $departmentidheck == 'D003'){
                            $sql_department = "SELECT department , departmentid FROM tbdepartment WHERE departmentid IN ('$departmentid','D016')";
                                        ...
                                        <div class="table-responsive">
                                            <table class='table table-striped table-bordered'>
                                                ...
                                                while($row = mssql_fetch_array($res)){
                                                    ...
                                                    $job_type = lang_thai_from_database($row["job_type"]);
