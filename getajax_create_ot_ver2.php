...
if($status=="show_ot_list"){
    ...
    // echo "$condition_departmentid ".$startdate."-".$enddate;
    ?>
    <br>
    ...
    <div class="table-responsive">
        <table class='table table-striped table-bordered'>
            ...
            if($num_ot > 0 ){
                ...
                ON tbemployee.positionid = tbposition.positionid 
                where tbemployee.delstatus=0 AND tbemployee.emp_level < 4
        ...
        //    mssql_query($update);
            ...
            if ($status_ot == "O") {
                ...
                if ($row0['work_type'] == 'H Sat , Sun' || $row0['work_type'] == 'H' || $row0['work_type'] == 'H Sat') {
                    ...
                    //echo "//".TimeDiff($calc_rate,$attDate2." 08:00:00")."//";
            ...
            while (strtotime($start_date_loop) < strtotime($end_date_loop)) {
                ...
                if($num_att_insert == 0){
                 // $insert = "";
                    ...
                    $insert_approve_default = "INSERT INTO tbatt_approve ( iworkdate, idayname_en, iShift, iattDateTime1, iattDateTime2, iworkhours, iotin, iotout, inormal, irate1, irate1_5, irate2, irate3, iremark, ifl, ishiftval, paycode, empno, status_approve)
                                                    VALUES ('$iworkdate_insert','$idayname_en_insert','$shift_insert','$iattDateTime1_insert','$iattDateTime2_insert','$workhours_insert','','','0','0','0','0','0','','no','','$paycode','$empno','1')";
