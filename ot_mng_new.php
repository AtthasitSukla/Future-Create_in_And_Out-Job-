		...
		success: function(data) {
			...
			if(data['type'] == 'add'){
				for(var i = 0;i<data['data'].length;i++){
					var attDateTime_in = data["data"][i]["attDateTime_in"]==null?"":data["data"][i]["attDateTime_in"];
					var attDateTime_out = data["data"][i]["attDateTime_out"]==null?"":data["data"][i]["attDateTime_out"];
					var shift_att = data["data"][i]["shift_att"]==null?"":data["data"][i]["shift_att"];
					tr += "<tr>";
					...
					tr += '<td align="center">'+attDateTime_in+'</td>';
					tr += '<td align="center">'+attDateTime_out+'</td>';
					tr += '<td align="center">'+shift_att+'</td>';
...
<div id="page-content">
    ...
    <table width="100%"  cellspacing="2" cellpadding="0" class="table table-striped table-bordered datatables" id="example">
		<tr >
			...
			<td width="106" align="center" bgcolor="#CCCCCC"><strong>Time In</strong></td>
			<td width="106" align="center" bgcolor="#CCCCCC"><strong>Time Out</strong></td>
			<td width="76" align="center" bgcolor="#CCCCCC"><strong>Shift Scan</strong></td>
			<td width="76" align="center" bgcolor="#CCCCCC"><strong>Shift</strong></td>
			<td width="76" align="center" bgcolor="#CCCCCC"><strong>OT</strong></td>
