...
$paycodeyear = $_REQUEST['paycodeyear'];
			...
			$select_check = "SELECT salary_rate FROM    tbatt_approve where empno='$empno' and paycode='$paycode' and salary_rate < 100  ";
			...
			$select="select  total_basic_salary,total_wage,other,paystatus,hbd,leave_without_pay,
tax,
late,
personal_leave,
absent,
other_deduct,empno, paycode, total_day, total_car_rice,total_fl, total_normal_day, total_wage, total_ot1, total_ot1_5, total_ot2, total_ot3, total_ot, att_reward, social_in, skill_reward, total_shift_val, total_salary,subtotal_salary ,ytd_social_in,ytd_income,bonus,no_attendance   
FROM            tbsalary where empno = '$empno' and paycode='$paycode' ";
				...
				$no_attendance = $row['no_attendance'];
				$basic_salary = $row['total_basic_salary'];
				$basic_wage = $row['total_wage'];
				if($no_attendance==''){
					$no_attendance = 0;
					}
...
<tr>
  ...
  <tr>
    <td align="center"><table width="100%" border="0" cellspacing="0" cellpadding="0">
		...
		if($row['total_wage']=='0'){
			...
			echo number_format($basic_salary, 2, '.', '');
				...
				echo number_format($basic_wage*$row['total_day'], 2, '.', '');
					...
					echo number_format($row['total_wage'], 2, '.', '');
				}
      ...
      <tr>
       ...
       <tr>
        <td width="52%" height="18"  style="padding-left:5px"><b><font size="1" face="Tahoma">ค่าทักษะ (Skill)</font></b></td>
        <td width="48%" align="right"  style="padding-right:5px"><b><font size="1" face="Tahoma"><?=number_format($row['skill_reward'], 2, '.', '');?></font></b></td>
      </tr>
      <tr>
    ...
    <td align="center" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        ...
        <td width="30%" align="right"  style="padding-right:5px"><b><font size="1" face="Tahoma"><?
         if($no_attendance>0){
				  echo number_format(($row['absent']+$no_attendance), 2, '.', '');
				 }else{
  ...
  <tr>
    <td align="center"><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td width="70%" height="18"  style="padding-left:5px"><b><font size="1" face="Tahoma">รวมรายได้ (TOTAL INCOME)</font></b></td>
        <td width="30%" align="right"  style="padding-right:5px"><b><font size="1" face="Tahoma"><?=number_format($row['subtotal_salary'], 2, '.', '');?></font></b></td>
      </tr>
    </table></td>
    <td align="center"><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td width="70%" height="18"  style="padding-left:5px"><b><font size="1" face="Tahoma">รวมรายการหัก (TOTAL DEDUCTION)</font></b></td>
        <td width="30%" align="right"  style="padding-right:5px"><b><font size="1" face="Tahoma"><?
		...
		$social_in = number_format($row['social_in'], 2, '.', '');
		 ...
		 if($emptype=='employee'){
			 $total_deduction = $late+$personal_leave+$absent+$other_deduct+$leave_without_pay+$social_in+$no_attendance;
			 }else{
			 $total_deduction = $social_in+$no_attendance;
			 }
  ...
  <tr>
    <td height="18" colspan="2" align="center"><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td width="28%" height="18" style="padding-left:5px"><b><font size="1" face="Tahoma">รายได้สุทธิ (NET INCOME)</font></b></td>
        <td width="19%" align="right"  style="padding-right:5px"><b><font size="1" face="Tahoma"><?=number_format($row['total_salary'], 2, '.', '');?></font></b></td>
        <td width="28%"  style="padding-left:5px"><b><font size="1" face="Tahoma">บาท (Baht)</font></b></td>
        <td width="25%">&nbsp;</td>
      </tr>
    </table></td>
    </tr>
  <tr>
	...
	if($row['paystatus']!='paid'){
		...
		mssql_query($sqlupdate2);
		 ...
		 if($no_attendance>0){
		$sqlupdate3= "update  tbatt_approve set status_noatt_deduct='deduct' where empno = '$empno' and paycode='$paycode' and status_noatt_deduct='New'";
		mssql_query($sqlupdate3);
		 }
	}
	...
	?><table width="100%" border="1" cellspacing="0" cellpadding="0">
  <tr>
    <td width="31%" height="18" align="center"><b><font size="1" face="Tahoma">เงินได้สะสม</font></b></td>
  ...
  <tr>
    <td height="18" align="center"><b><font size="1" face="Tahoma">( YTD INCOME )</font></b></td>
   ...
   <tr>
    <td height="18" align="center"><b><font size="1" face="Tahoma"><?=number_format($ytd_income, 2, '.', '');?></font></b></td>
