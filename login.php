	...
	<div class="panel panel-primary">
		<div class="panel-body">
			<h4 class="text-center" style="margin-bottom: 25px;">Log in to get started</h4>
				...
				<input type="hidden" id="ref" name="ref" value="<?=$_REQUEST['ref']?>">
						...
						<div class="clearfix">
							<div class="pull-right"><label><input type="checkbox" name="checkc" value="yes" style="margin-bottom: 20px" checked=""> Remember Me</label></div>
						</div> 
					</form>
