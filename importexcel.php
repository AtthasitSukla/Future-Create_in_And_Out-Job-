...
if($status==''){
  ...
  <tr >
    ...
    <td width="12%" align="center"><strong>OEM Return Number</strong></td>
    <td width="12%" align="center"><strong>Truck No</strong></td>
   
    <td width="9%" align="center"><strong>Print OER</strong></td>
    </tr>
    </table>
	<?
