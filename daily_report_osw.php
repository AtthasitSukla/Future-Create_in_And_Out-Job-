...
<head>
	<meta charset="utf-8">
	<title>I-Wis HRS : Daily Report OSW</title>
...
function showatt_month(){
	...
	$.post("getajax_daily_report.php", { status:"show_daily_osw",tsite2:tsite2,ddate:ddate,mmonth:mmonth,yyear:yyear,
	sid: Math.random() },
   function(data) {
	 $("#xpane").html(data);
     $(".loader").hide();
...
function exportatt_month(){
	...
	function show_receive_box(report_date,shift){
		$("#show_detail_head").html("Receive performace");
		$("#show_detail_body").html("Loading....");
		$("#myModal_show_detail").modal();
	...
	function show_cleaning_box(report_date,shift){
	...
	function show_issue_on_time(report_date,shift){
...
<body bgcolor="#FFFFFF" style="padding-top: 10px; padding-left:2px">
	<!-- Modal -->
