<?
	$empno_cal = $_SESSION['admin_userid'];
...
$select_v1="select startdate  from tbemployee emp JOIN tbposition pos ON emp.positionid = pos.positionid where emp.empno = '$empno_cal' and startdate is not null ";
	$re_v1=mssql_query($select_v1);
	$num_v1=mssql_num_rows($re_v1);
	if($num_v1>0){
